...
module KMonad.Util.Keyboard.OS (Keycode, keycodeNames) where
...
#ifdef linux_HOST_OS
import KMonad.Util.Keyboard.Linux ( Keycode, keycodeNames )
#endif

#ifdef mingw32_HOST_OS
import KMonad.Util.Keyboard.Windows ( Keycode, keycodeNames )
#endif

#ifdef darwin_HOST_OS
import KMonad.Util.Keyboard.Mac ( Keycode, keycodeNames )
#endif
