...
data Dispatch = Dispatch
  ...
  , _rerunBuf     :: TVar (Seq.Seq KeyEvent)
...
class Hs.HasHookStore e => HasDispatch e where
  dispatch :: Lens' e Dispatch

instance {-# OVERLAPS #-} (HasDispatch e) => Hs.HasHookStore e where
  hookStore = dispatch . dpHookStore
